      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View className='flex-col items-start justify-center mt-5 px-5'>
          ...
          <View className='flex-row gap-x-1 items-center mt-2'>
            <Text className='text-light-200 text-small'>{movie?.release_date?.split('-')[0]}</Text>
            <Text className='text-light-200 text-small'>{movie?.runtime}min</Text>
          </View>
          <View className='flex-row items-center bg-dark-100 px-2 py-1 rounded-md gap-x-1 mt-2'>
            ...
            <Text className='text-light-200 text-small'>({movie?.vote_count} votes)</Text>
          </View>
